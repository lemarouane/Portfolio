    ...
    const socialMediaLinks = [
        {
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://www.linkedin.com/in/marouane-haddad/', '_blank'),
        },
        {
            initial: { y: 50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://www.instagram.com/le_mar1_h/', '_blank'),
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://github.com/lemarouane', '_blank')
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://dribbble.com/maromar1', '_blank')
        },
        {
            ...
            height: 310,
            tabIndex: 0,
            onClick: () => window.open('mailto:marouane.haddad@esi.ac.ma', "_self")
        }
