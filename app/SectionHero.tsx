        ...
        <section ref={ref} className='safe-x-padding mt-10 mb-[172px]' aria-label='Hero Section'>
            <div className='grid grid-flow-row gap-10 xl:grid-cols-2 xl:grid-flow-col xl:gap-0'>
                ...
                <div className='flex flex-col items-center justify-center order-2 xl:items-start xl:order-1'>
                    ...
                    >
                        Welcome to Marouane Haddad&apos;s Portfolio
                    </motion.p>
                    <motion.h2
                    ...
                    <motion.p
                        ...
                        aria-label="I am Marouane Haddad. A passionate Full Stack Web Developer and artificial intelligence Engineer based in Rabat, Morocco."
                    >
                        I am Marouane Haddad. A passionate Full Stack Web Developer and artificial intelligence Engineer based in Rabat, Morocco.
                    </motion.p>
                </div>
                {/* second */}
